...
#define texelFetch(a, b, c) a.Load(int3(b,c))
...
bool traceScreenSpaceRay1(
	...
	vec4 H0 = mul(proj, vec4(csOrig, 1.0));
	vec4 H1 = mul(proj, vec4(csEndPoint, 1.0));
	...
	float offset = (distanceSquared(P0, P1) < 0.0001) ? 0.01 : 0.0;
	P1 += vec2(offset, offset);
	vec2 delta = P1 - P0;
